...
class EventSkeletonEngine:
    ...
    def _ensure_baseline_events(self, defs: List[Dict[str, Any]]) -> List[Dict[str, Any]]:
        ...
        baseline_defs = [
            ...
            {
                "id": "daily_proactive_request_help",
                "type": "daily",
                "title": "室友请求你帮忙",
                "priority": 56,
                "cooldown_days": 2,
                "once": False,
                "triggers": {"day_min": 2, "active_any": ["tang_mengqi"]},
                "meta": {
                    "injected": True,
                    "npc_proactive": True,
                    "npc_proactive_weight": 9,
                    "kind": "request",
                    "initiator": "tang_mengqi",
                    "weekly_bias": {"active": 5, "progress": 3},
                    "public_line": "唐梦琪突然来找你，希望你在寝室群里帮她说句话。",
                    "info_fragments": [
                        {"text": "她刻意避开某个名字，显然不想把矛盾说穿。", "info_gate": {"day_min": 2}},
                        {"text": "你能感觉到她在压着火气。", "info_gate": {"relation_target": {"char": "tang_mengqi", "tension_gte": 52}}},
                    ],
                },
            },
            {
            ...
            {
                "id": "key_asymmetry_rumor",
                "type": "key",
                "title": "寝室传言分歧",
                "priority": 66,
                "cooldown_days": 2,
                "once": False,
                "triggers": {"day_min": 2, "active_any": ["li_yinuo"], "flags_all_false": ["irrev:rumor_public_break"]},
                "options": [
                    {
                        "id": "clarify",
                        "attitude": "澄清",
                        "effects": {"dorm_mood_delta": 2},
                        "info_gate": {"memory_any_tags": ["char:lin_sa", "char:tang_mengqi"]},
                    },
                    {
                        "id": "observe",
                        "attitude": "观望",
                    ...
                    },
                    {
                        ...
                        "effects": {
                            ...
                            "irreversible": "rumor_public_break",
                        },
                        "info_gate": {
                            "relation_target": {"char": "tang_mengqi", "tension_gte": 55},
                            "flags_all_false": ["irrev:rumor_public_break"],
                        },
                    },
                ],
                "meta": {
                    "injected": True,
                    "npc_proactive": True,
                    "npc_proactive_weight": 8,
                    "kind": "conflict",
                    "initiator": "li_yinuo",
                    "weekly_bias": {"escalate": 10, "active": 4},
                    "relation_stage_bias": {"tang_mengqi": {"tense": 8, "hostile": 12}},
                    "public_line": "你发现同一件事，三个人给你的版本明显互相冲突。",
                    "info_fragments": [
                        {"text": "林飒暗示‘有人昨晚偷偷改了寝室值日表’。", "info_gate": {"day_min": 2}},
                        {"text": "唐梦琪私下强调‘她只是被动应对’，请求你先别公开追问。", "info_gate": {"relation_target": {"char": "tang_mengqi", "trust_gte": 52}}},
                        {"text": "苏浅给你的版本最冷静，但遗漏了关键时间点。", "info_gate": {"day_min": 2}},
                    ],
                },
            },
            {
    ...
    def _default_definitions(self) -> List[Dict[str, Any]]:
        return [
            ...
            },
            {
                ...
                "priority": 70,
                "cooldown_days": 3,
                "triggers": {"relation_any": {"tension_gte": 62}, "relation_stage_any": ["tense", "hostile"]},
                "options": [
                    {
                        "id": "support",
                        "attitude": "支持",
